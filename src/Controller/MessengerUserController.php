 ...
 */
class MessengerUserController extends ControllerBase
{
    ...
    <th>To</th>
        ...
        return [
            'allRead' => \Drupal::formBuilder()->getForm('Drupal\messenger\Form\AllReadForm'),
            'form' => \Drupal::formBuilder()->getForm('Drupal\messenger\Form\MessengerUserForm'),
            $element];
    }
}